...
const THEMES = {
  dark: {
    card:        { backgroundColor: "#132d1c", border: "1px solid #1e4430" } as React.CSSProperties,
    eyebrow:     "#7fa88a",
    rule:        "#1e4430",
    muted:       "#7fa88a",
    input:       { backgroundColor: "#0a1f14", border: "1px solid #1e4430", color: "#f5f5f0" } as React.CSSProperties,
    inputClass:  "rounded-full",
    googleBtn:   { backgroundColor: "#f5f5f0", color: "#0a1f14" } as React.CSSProperties,
    toggleBorder: "#1e4430",
  },
  paper: {
    card: {
      ...
      border:             "1px solid rgba(32,24,15,0.25)",
      boxShadow:          "0 18px 50px rgba(0,0,0,0.45)",
    } as React.CSSProperties,
    eyebrow:     "#5a4a32",
    rule:        "rgba(32,24,15,0.25)",
    muted:       "#5a4a32",
    input:       { backgroundColor: "#ffffff", border: "1px solid rgba(32,24,15,0.3)", color: "#20180f" } as React.CSSProperties,
    inputClass:  "rounded-lg",
    googleBtn:   { backgroundColor: "#20180f", color: "#f5f5f0" } as React.CSSProperties,
    toggleBorder: "rgba(32,24,15,0.3)",
  },
} as const;

export default function SignInCard({ theme = "dark" }: { theme?: "dark" | "paper" }) {
  ...
  const inputCls = `w-full ${t.inputClass} px-5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-700`;

  return (
    <div className="w-full max-w-sm rounded-3xl p-8 space-y-6" style={t.card}>
      <div className="text-center">
        <h1 className="flex justify-center">
          <RansomLogo className="logo--login" />
        </h1>
        <p className="mt-1 text-xs uppercase tracking-widest" style={{ color: t.eyebrow }}>
      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 h-px" style={{ backgroundColor: t.rule }} />
      ...
      <div
        ...
        style={{ border: `1px solid ${t.toggleBorder}` }}
      >
